...
class RankService
{
    ...
    public function setRankIndex(): void
    {
        ...
        for ($i = 1; $i < 6; $i++) {
            ...
            $top_head = '<div class="col-md-4 col-sm-12 col-xs-12 active">
                              <div class="box-title pg-0">
                                ...
                                <div class="more pull-right">
                                  <a href="/rank/'.$i.'.html" class="text-muted" title="更多">更多 <i class="icon iconfont">&#xe65e;</i></a>
                                </div>
                              </div>
            ...
            foreach ($rows as $row){
                ...
                $top_head.='<li class="list p-0"><a class="pull-left" href="/details/'.AppService::dechexId($row['vod_id']).'.html" title="'.$row['vod_name'].'"><em class="num '.AppService::getActive($active).'"> '.$num.'</em>'.$row['vod_name'].'</a>
    ...
    public function setRankClassify(): void
    {
        ...
        foreach ($rows as $row){
            ...
            <a class="video-pic loading" data-original="'.$row['vod_pic'].'" href="/details/'.AppService::dechexId($row['vod_id']).'.html" title="'.$row['vod_name'].'">
