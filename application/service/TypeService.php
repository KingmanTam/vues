    ...
    public function setData(): void
    {
        ...
        foreach ($rows as $row){
            ...
            $item = '<li class="col-md-2 col-sm-3 col-xs-4">
              <a class="video-pic loading" data-original="'.$row['vod_pic'].'" href="'.$this->getLink(8,$par).'" title="'.$row['vod_name'].'">
        ...
        $pageurl = '/'.App::$args['dir'].'/'.App::$args['class'].'_'.App::$args['area'].'_'.App::$args['year'].'_{page}.html';
    ...
    public function getLink($type,$p): string
    {
        ...
        switch ($type){
            ...
            case 7:
                ...
                break;
            case 8:
                return '/details/'.AppService::dechexId($p['id']).'.html';
        }
        return $path.'.html';
    }
