...
class SeoService
{
    public function robots(): void
    {
        ...
        App::$content = str_replace('{mv:site_url}', App::$full_url,$html);
    }
    ...
    public function sitemap(): void
    {
        ...
        $rows = Db::selectAll('select * from mac_vod order by vod_time_add DESC limit 1000');
        $item_html = '';
        foreach ($rows as $row){
            $item_html.='<url>
                            <loc>https://'.App::$full_url.'/details/'.AppService::dechexId($row['vod_id']).'html</loc>
